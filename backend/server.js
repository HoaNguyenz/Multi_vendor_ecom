...
//         const result = await sql.query`SELECT * FROM Nguoi_dung_va_Gio_hang WHERE Sdt = ${decoded.id}`;
//         const user = result.recordset[0];
...
CREATE TABLE Dia_chi (
    ...
    So_nha NVARCHAR(100),
    Phuong_or_Xa NVARCHAR(100),
    Quan_or_Huyen NVARCHAR(100),
    Tinh_or_TP NVARCHAR(100),
...
CREATE TABLE Danh_muc_hang (
    ...
    PRIMARY KEY (Ma_cua_hang, Ten_danh_muc),
...
CREATE TABLE San_pham (
    ...
    Ten_danh_muc NVARCHAR(400) NOT NULL,
    FOREIGN KEY (Ma_cua_hang) REFERENCES Nguoi_ban_va_Cua_hang(Ma_cua_hang),
    FOREIGN KEY (Ma_cua_hang, Ten_danh_muc) REFERENCES Danh_muc_hang(Ma_cua_hang, Ten_danh_muc)
);
...
// req.use: { id: '1212      ', iat: 1732751706, exp: 1732838106 }
