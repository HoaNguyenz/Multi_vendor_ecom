  ...
  return (
    <div className="w-full bg-blue-400 h-[60px] flex items-center justify-between px-4">
      ...
      <div className="relative w-[50%] max-w-[600px]">
        ...
        />
        <AiOutlineSearch size={20} className="absolute right-3 top-2.5 text-gray-500 cursor-pointer" />
      </div>

      {/* Biểu tượng Thông báo, Giỏ hàng, và Profile */}
      <div className="flex items-center space-x-6 text-white">
        <AiOutlineBell size={28} className="cursor-pointer" /> {/* Tăng kích thước lên 28 */}
        <Link to="/cart">
          <AiOutlineShoppingCart size={28} className="cursor-pointer" /> {/* Tăng kích thước lên 28 */}
        </Link>
        <div className="relative">
          ...
          >
            <CgProfile size={28} className="cursor-pointer" /> {/* Tăng kích thước lên 28 */}
          </button>

          {/* Menu profile với hai nút riêng biệt */}
          {profileMenu && (
